import { defineComponent as p, inject as n, computed as c, openBlock as o, createElementBlock as e, mergeProps as g, unref as t, renderSlot as u, createCommentVNode as y, createElementVNode as a } from "vue";
const f = ["width", "height", "fill", "transform"], L = { key: 0 }, w = /* @__PURE__ */ a("path", { d: "M178,78A84,84,0,1,0,78,178,84,84,0,1,0,178,78Zm42,82a60.75,60.75,0,0,1-.38,6.65l-44-44a83.31,83.31,0,0,0,4-19.34A60.09,60.09,0,0,1,220,160Zm-119.84-4.16a60.07,60.07,0,0,1,55.68-55.68A60.07,60.07,0,0,1,100.16,155.84Zm52.51-79.5a83.31,83.31,0,0,0-19.34,4l-44-44A60.75,60.75,0,0,1,96,36,60.09,60.09,0,0,1,152.67,76.34ZM64.19,45.16l46.73,46.73a85,85,0,0,0-19,19L45.16,64.19A60.45,60.45,0,0,1,64.19,45.16ZM36,96a60.75,60.75,0,0,1,.38-6.65l44,44a83.31,83.31,0,0,0-4,19.34A60.09,60.09,0,0,1,36,96Zm67.33,83.66a83.31,83.31,0,0,0,19.34-4l44,44A60.75,60.75,0,0,1,160,220,60.09,60.09,0,0,1,103.33,179.66Zm88.48,31.18-46.73-46.73a85,85,0,0,0,19-19l46.73,46.73A60.45,60.45,0,0,1,191.81,210.84Z" }, null, -1), C = [
  w
  ...
  setup(d) {
    const s = d, Z = n("weight", "regular"), _ = n("size", "1em"), h = n("color", "currentColor"), A = n("mirrored", !1), l = c(() => s.weight ?? Z), i = c(() => s.size ?? _), m = c(() => s.color ?? h), M = c(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : A ? "scale(-1, 1)" : void 0);
    return (r, F) => (o(), e("svg", g({
      ...
      u(r.$slots, "default"),
      t(l) === "bold" ? (o(), e("g", L, C)) : t(l) === "duotone" ? (o(), e("g", k, S)) : t(l) === "fill" ? (o(), e("g", z, E)) : t(l) === "light" ? (o(), e("g", N, H)) : t(l) === "regular" ? (o(), e("g", P, W)) : t(l) === "thin" ? (o(), e("g", $, q)) : y("", !0)
    ], 16, f));
  }
});
export {
