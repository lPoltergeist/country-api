import { defineComponent as M, inject as n, computed as a, openBlock as o, createElementBlock as l, mergeProps as p, unref as t, renderSlot as g, createCommentVNode as u, createElementVNode as e } from "vue";
const y = ["width", "height", "fill", "transform"], V = { key: 0 }, f = /* @__PURE__ */ e("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm76,72.25L182,99.4,140,69.78V44.87A84.23,84.23,0,0,1,204,92.25ZM104.5,160,90.21,117.33,128,90.68l37.79,26.65L151.5,160ZM116,44.87V69.78L74,99.4,52,92.25A84.23,84.23,0,0,1,116,44.87ZM44,128a84.26,84.26,0,0,1,1-12.79l21.57,7,16,47.74L69.36,188.06A83.72,83.72,0,0,1,44,128Zm44.73,74.23L102,184h52l13.25,18.23a83.81,83.81,0,0,1-78.54,0Zm97.91-14.17L173.48,170l16-47.74,21.57-7a84,84,0,0,1-24.39,72.85Z" }, null, -1), H = [
  f
  ...
  setup(r) {
    const Z = r, h = n("weight", "regular"), d = n("size", "1em"), m = n("color", "currentColor"), _ = n("mirrored", !1), s = a(() => Z.weight ?? h), c = a(() => Z.size ?? d), A = a(() => Z.color ?? m), L = a(() => Z.mirrored !== void 0 ? Z.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (i, F) => (o(), l("svg", p({
      ...
      g(i.$slots, "default"),
      t(s) === "bold" ? (o(), l("g", V, H)) : t(s) === "duotone" ? (o(), l("g", w, v)) : t(s) === "fill" ? (o(), l("g", x, z)) : t(s) === "light" ? (o(), l("g", B, b)) : t(s) === "regular" ? (o(), l("g", E, W)) : t(s) === "thin" ? (o(), l("g", $, q)) : u("", !0)
    ], 16, y));
  }
});
export {
