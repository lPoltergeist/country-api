...
const C = ["width", "height", "fill", "transform"], Z = { key: 0 }, L = /* @__PURE__ */ a("path", { d: "M232,60H213l19.51-19.51a12,12,0,1,0-17-17L196,43V24a12,12,0,0,0-24,0V50A68,68,0,0,0,96,63.87l0,0h0l0,0C55.45,103.68,25.18,197,21.78,207.77A20,20,0,0,0,40,236a20.12,20.12,0,0,0,8.24-1.78c7.64-2.42,56.79-18.34,98.91-41.82l.54-.3c17.1-9.57,33-20.39,44.44-32A68,68,0,0,0,206,84h26a12,12,0,0,0,0-24Zm-56.89,83.12-.09.09c-8.11,8.28-19.11,16.2-31.33,23.52l-23.21-23.21a12,12,0,1,0-17,17l18.22,18.22c-30.29,15.17-62.13,26.42-75.26,30.82,6.77-20.22,29.79-84.8,58.34-119.74l30.7,30.7a12,12,0,1,0,17-17L122.54,73.58a44,44,0,0,1,52.57,69.54Z" }, null, -1), w = [
  ...
  setup(d) {
    const s = d, h = c("weight", "regular"), _ = c("size", "1em"), p = c("color", "currentColor"), m = c("mirrored", !1), l = n(() => s.weight ?? h), i = n(() => s.size ?? _), g = n(() => s.color ?? p), u = n(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
    return (r, F) => (o(), e("svg", A({
      ...
      V(r.$slots, "default"),
      t(l) === "bold" ? (o(), e("g", Z, w)) : t(l) === "duotone" ? (o(), e("g", H, S)) : t(l) === "fill" ? (o(), e("g", v, z)) : t(l) === "light" ? (o(), e("g", B, b)) : t(l) === "regular" ? (o(), e("g", E, W)) : t(l) === "thin" ? (o(), e("g", $, q)) : f("", !0)
    ], 16, C));
  }
});
export {
