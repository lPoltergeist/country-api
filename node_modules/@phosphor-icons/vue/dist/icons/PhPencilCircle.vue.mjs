...
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, w = /* @__PURE__ */ a("path", { d: "M204.37,51.6A108.08,108.08,0,1,0,236,128,108.09,108.09,0,0,0,204.37,51.6ZM92,200a12,12,0,1,1,24,0v11.11a83.78,83.78,0,0,1-24-7.22Zm48,0a12,12,0,1,1,24,0v3.89a83.78,83.78,0,0,1-24,7.22Zm-33.86-52h43.72l7.57,16.42A35.95,35.95,0,0,0,128,173.22a35.95,35.95,0,0,0-29.43-8.79Zm11.08-24L128,100.62,138.78,124ZM188,186.79V176a12.15,12.15,0,0,0-1.1-5l-48-104a12,12,0,0,0-21.8,0L69.1,171a12.15,12.15,0,0,0-1.1,5v10.77a84,84,0,1,1,120,0Z" }, null, -1), V = [
  ...
  setup(d) {
    const l = d, h = n("weight", "regular"), _ = n("size", "1em"), m = n("color", "currentColor"), Z = n("mirrored", !1), s = i(() => l.weight ?? h), c = i(() => l.size ?? _), p = i(() => l.color ?? m), g = i(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (r, F) => (o(), e("svg", u({
      ...
      A(r.$slots, "default"),
      t(s) === "bold" ? (o(), e("g", f, V)) : t(s) === "duotone" ? (o(), e("g", k, C)) : t(s) === "fill" ? (o(), e("g", S, B)) : t(s) === "light" ? (o(), e("g", N, b)) : t(s) === "regular" ? (o(), e("g", E, $)) : t(s) === "thin" ? (o(), e("g", j, q)) : M("", !0)
    ], 16, y));
  }
});
export {
