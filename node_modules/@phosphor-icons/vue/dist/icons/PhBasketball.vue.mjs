...
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, V = /* @__PURE__ */ s("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20ZM60,177.28A83.59,83.59,0,0,1,44.87,140H75.14A83.1,83.1,0,0,1,60,177.28ZM44.87,116A83.59,83.59,0,0,1,60,78.72,83.1,83.1,0,0,1,75.14,116ZM116,211.13a83.63,83.63,0,0,1-39-16.46A106.94,106.94,0,0,0,99.34,140H116ZM116,116H99.34A106.94,106.94,0,0,0,77,61.33a83.63,83.63,0,0,1,39-16.46Zm80-37.28A83.59,83.59,0,0,1,211.13,116H180.86A83.1,83.1,0,0,1,196,78.72ZM140,211.13V140h16.66A106.94,106.94,0,0,0,179,194.67,83.63,83.63,0,0,1,140,211.13ZM156.66,116H140V44.87a83.63,83.63,0,0,1,39,16.46A106.94,106.94,0,0,0,156.66,116ZM196,177.28A83.1,83.1,0,0,1,180.86,140h30.27A83.59,83.59,0,0,1,196,177.28Z" }, null, -1), v = [
  ...
  setup(Z) {
    const A = Z, d = a("weight", "regular"), c = a("size", "1em"), l = a("color", "currentColor"), _ = a("mirrored", !1), n = i(() => A.weight ?? d), r = i(() => A.size ?? c), m = i(() => A.color ?? l), M = i(() => A.mirrored !== void 0 ? A.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (h, G) => (o(), e("svg", H({
      ...
      g(h.$slots, "default"),
      t(n) === "bold" ? (o(), e("g", f, v)) : t(n) === "duotone" ? (o(), e("g", w, S)) : t(n) === "fill" ? (o(), e("g", z, C)) : t(n) === "light" ? (o(), e("g", b, E)) : t(n) === "regular" ? (o(), e("g", P, $)) : t(n) === "thin" ? (o(), e("g", j, D)) : u("", !0)
    ], 16, y));
  }
});
export {
