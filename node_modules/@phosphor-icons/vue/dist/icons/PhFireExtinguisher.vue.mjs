...
const A = ["width", "height", "fill", "transform"], y = { key: 0 }, M = /* @__PURE__ */ a("path", { d: "M219.45,44.51,170.07,29.7,185,22.93A12,12,0,1,0,175,1.08l-41.78,19A84.09,84.09,0,0,0,52,104V208a12,12,0,0,0,24,0V180H92v52a20,20,0,0,0,20,20h48a20,20,0,0,0,20-20V104a44.08,44.08,0,0,0-32-42.32V48.13L212.55,67.5A11.81,11.81,0,0,0,216,68a12,12,0,0,0,3.45-23.49ZM76,156V104a60.1,60.1,0,0,1,48-58.79V61.68A44.06,44.06,0,0,0,92,104v52Zm40,72V180h40v48Zm40-124v52H116V104a20,20,0,0,1,40,0Z" }, null, -1), f = [
  ...
  setup(d) {
    const n = d, c = i("weight", "regular"), V = i("size", "1em"), _ = i("color", "currentColor"), m = i("mirrored", !1), s = r(() => n.weight ?? c), l = r(() => n.size ?? V), v = r(() => n.color ?? _), p = r(() => n.mirrored !== void 0 ? n.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
    return (h, D) => (o(), e("svg", Z({
      ...
      u(h.$slots, "default"),
      t(s) === "bold" ? (o(), e("g", y, f)) : t(s) === "duotone" ? (o(), e("g", w, L)) : t(s) === "fill" ? (o(), e("g", S, C)) : t(s) === "light" ? (o(), e("g", B, N)) : t(s) === "regular" ? (o(), e("g", b, W)) : t(s) === "thin" ? (o(), e("g", $, F)) : H("", !0)
    ], 16, A));
  }
});
export {
