...
const u = ["width", "height", "fill", "transform"], H = { key: 0 }, C = /* @__PURE__ */ e("path", { d: "M48,120a12,12,0,0,0,12-12V44h76V92a12,12,0,0,0,12,12h48v4a12,12,0,1,0,24,0V88a12,12,0,0,0-3.51-8.48l-56-56A12,12,0,0,0,152,20H56A20,20,0,0,0,36,40v68A12,12,0,0,0,48,120ZM183,80H160V57Zm53,128a12,12,0,0,1-12,12H196a12,12,0,0,1-12-12V152a12,12,0,0,1,24,0v44h16A12,12,0,0,1,236,208ZM91.78,196.8a24.7,24.7,0,0,1-11,18c-6,4-13.26,5.15-19.73,5.15a63.75,63.75,0,0,1-16.23-2.21,12,12,0,1,1,6.46-23.11c6.81,1.85,15,1.61,16.39.06a2.48,2.48,0,0,0,.21-.71c-1.94-1.23-6.82-2.64-9.88-3.53-5.39-1.56-11-3.17-15.75-6.26-7.62-4.92-11.21-12.45-10.1-21.19a24.44,24.44,0,0,1,10.68-17.76c6.07-4.09,14.17-5.83,24.1-5.17A69,69,0,0,1,79,142a12,12,0,0,1-6.1,23.21c-6.35-1.63-13.61-1.5-16.07-.33a79.69,79.69,0,0,0,7.92,2.59c5.47,1.58,11.67,3.37,16.8,6.82C89.33,179.53,93,187.53,91.78,196.8Zm76,2A43.23,43.23,0,0,0,172,180c0-22-16.15-40-36-40s-36,18-36,40,16.15,40,36,40a32.78,32.78,0,0,0,15.25-3.77l.27.26a12,12,0,0,0,17-17ZM124,180c0-8.67,5.5-16,12-16s12,7.33,12,16c0,.23,0,.46,0,.69a12,12,0,0,0-15.51,14.56C127.62,193.16,124,187,124,180Z" }, null, -1), y = [
  ...
  setup(r) {
    const s = r, d = l("weight", "regular"), _ = l("size", "1em"), A = l("color", "currentColor"), Z = l("mirrored", !1), c = n(() => s.weight ?? d), i = n(() => s.size ?? _), M = n(() => s.color ?? A), m = n(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (h, G) => (t(), o("svg", V({
      ...
      g(h.$slots, "default"),
      a(c) === "bold" ? (t(), o("g", H, y)) : a(c) === "duotone" ? (t(), o("g", f, S)) : a(c) === "fill" ? (t(), o("g", x, B)) : a(c) === "light" ? (t(), o("g", N, E)) : a(c) === "regular" ? (t(), o("g", P, $)) : a(c) === "thin" ? (t(), o("g", j, F)) : v("", !0)
    ], 16, u));
  }
});
export {
