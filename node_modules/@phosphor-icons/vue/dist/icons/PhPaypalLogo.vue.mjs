import { defineComponent as g, inject as h, computed as n, openBlock as o, createElementBlock as e, mergeProps as Z, unref as t, renderSlot as u, createCommentVNode as M, createElementVNode as a } from "vue";
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, L = /* @__PURE__ */ a("path", { d: "M223.27,91.08a59.82,59.82,0,0,0-19.5-16.27A60,60,0,0,0,144,20H84A20,20,0,0,0,64.6,35.15l-36,144A20,20,0,0,0,48,204H70.39l-1.79,7.15A20,20,0,0,0,88,236h31.5a20,20,0,0,0,19.4-15.15L147.13,188H176a60,60,0,0,0,47.29-96.92ZM87.13,44H144a35.77,35.77,0,0,1,28.37,13.85A36.18,36.18,0,0,1,178,68.06c-.66,0-1.31-.06-2-.06H120A20,20,0,0,0,100.6,83.15L76.39,180H53.13Zm90.76,48.05A35.93,35.93,0,0,1,144,116H117.13l6-24H176C176.62,92,177.26,92,177.89,92.05Zm33,44.68A35.94,35.94,0,0,1,176,164H144a20,20,0,0,0-19.4,15.15L116.39,212H93.13l18-72H144a59.89,59.89,0,0,0,56.1-38.75,36.12,36.12,0,0,1,10.82,35.48Z" }, null, -1), w = [
  L
  ...
  setup(r) {
    const s = r, c = h("weight", "regular"), d = h("size", "1em"), _ = h("color", "currentColor"), H = h("mirrored", !1), l = n(() => s.weight ?? c), i = n(() => s.size ?? d), p = n(() => s.color ?? _), m = n(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : H ? "scale(-1, 1)" : void 0);
    return (A, F) => (o(), e("svg", Z({
      ...
      u(A.$slots, "default"),
      t(l) === "bold" ? (o(), e("g", f, w)) : t(l) === "duotone" ? (o(), e("g", k, C)) : t(l) === "fill" ? (o(), e("g", S, B)) : t(l) === "light" ? (o(), e("g", N, b)) : t(l) === "regular" ? (o(), e("g", E, W)) : t(l) === "thin" ? (o(), e("g", $, q)) : M("", !0)
    ], 16, y));
  }
});
export {
