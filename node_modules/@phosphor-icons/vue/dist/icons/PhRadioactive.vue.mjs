...
const H = ["width", "height", "fill", "transform"], M = { key: 0 }, f = /* @__PURE__ */ e("path", { d: "M128,112a16,16,0,1,1-16,16A16,16,0,0,1,128,112ZM96,128a12,12,0,0,0-12-12H44.47a83.88,83.88,0,0,1,31.2-54.11L95.38,96a12,12,0,1,0,20.78-12l-22-38a20,20,0,0,0-28.87-6.34,107.85,107.85,0,0,0-45.26,78.4,20.22,20.22,0,0,0,5.21,15.43A20,20,0,0,0,40,140H84A12,12,0,0,0,96,128Zm139.92-9.94a107.81,107.81,0,0,0-45.26-78.39A20,20,0,0,0,161.79,46L139.84,84a12,12,0,0,0,20.78,12l19.71-34.13A83.88,83.88,0,0,1,211.53,116H172a12,12,0,0,0,0,24h44a20,20,0,0,0,14.71-6.51A20.22,20.22,0,0,0,235.92,118.06ZM160.4,160.11a12,12,0,0,0-20.79,12L159.19,206a84.33,84.33,0,0,1-62.38,0l19.58-33.91a12,12,0,0,0-20.79-12l-21.82,37.8a20,20,0,0,0,8.91,28.15,108.24,108.24,0,0,0,90.62,0,20,20,0,0,0,8.91-28.15Z" }, null, -1), w = [
  ...
  setup(d) {
    const l = d, A = n("weight", "regular"), h = n("size", "1em"), _ = n("color", "currentColor"), m = n("mirrored", !1), s = i(() => l.weight ?? A), r = i(() => l.size ?? h), p = i(() => l.color ?? _), Z = i(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
    return (c, D) => (t(), o("svg", L({
      ...
      u(c.$slots, "default"),
      a(s) === "bold" ? (t(), o("g", M, w)) : a(s) === "duotone" ? (t(), o("g", k, S)) : a(s) === "fill" ? (t(), o("g", z, B)) : a(s) === "light" ? (t(), o("g", N, E)) : a(s) === "regular" ? (t(), o("g", P, W)) : a(s) === "thin" ? (t(), o("g", $, R)) : y("", !0)
    ], 16, H));
  }
});
export {
