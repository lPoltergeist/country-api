...
const M = ["width", "height", "fill", "transform"], f = { key: 0 }, w = /* @__PURE__ */ o("path", { d: "M228,67.24a39.77,39.77,0,0,0-12.51-28.52C199.91,24,174.71,24.5,159.29,39.93L142.48,56.84a28,28,0,0,0-35.64,3.29l-9,9a20,20,0,0,0-.73,27.49L48.9,144.84A43.76,43.76,0,0,0,37,185.28l-7.5,17.19a17.66,17.66,0,0,0,3.71,19.65,19.9,19.9,0,0,0,22.15,4.19l16.31-7.13a43.88,43.88,0,0,0,39.45-12.09l48.24-48.26a20,20,0,0,0,27.47-.73l9-9a28.06,28.06,0,0,0,3.26-35.72l17.23-17.33A39.69,39.69,0,0,0,228,67.24ZM94.15,190.11a20,20,0,0,1-20,5,11.93,11.93,0,0,0-8.32.47L57,199.38,60.69,191a12,12,0,0,0,.37-8.64,19.92,19.92,0,0,1,4.81-20.55l48.2-48.22,28.28,28.3Zm105.14-111-25.37,25.52a12,12,0,0,0,0,16.95l4.88,4.89a4,4,0,0,1,0,5.66l-6.14,6.15-55-55.05,6.14-6.14a4,4,0,0,1,5.65,0L134.35,82a12,12,0,0,0,8.49,3.51h0A12,12,0,0,0,151.34,82l24.94-25.08c6.3-6.3,16.48-6.63,22.71-.74a16,16,0,0,1,.3,23Z" }, null, -1), k = [
  ...
  setup(d) {
    const s = d, h = n("weight", "regular"), _ = n("size", "1em"), p = n("color", "currentColor"), L = n("mirrored", !1), e = c(() => s.weight ?? h), i = c(() => s.size ?? _), m = c(() => s.color ?? p), g = c(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : L ? "scale(-1, 1)" : void 0);
    return (r, G) => (a(), t("svg", A({
      ...
      Z(r.$slots, "default"),
      l(e) === "bold" ? (a(), t("g", f, k)) : l(e) === "duotone" ? (a(), t("g", C, S)) : l(e) === "fill" ? (a(), t("g", z, E)) : l(e) === "light" ? (a(), t("g", N, P)) : l(e) === "regular" ? (a(), t("g", V, $)) : l(e) === "thin" ? (a(), t("g", j, D)) : y("", !0)
    ], 16, M));
  }
});
export {
