...
const u = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ s("path", { d: "M227.85,213.52l-22-176A20,20,0,0,0,186,20H70A20,20,0,0,0,50.15,37.52l-22,176A20,20,0,0,0,48,236H88.69A19.94,19.94,0,0,0,108.07,221l19.93-77,19.91,76.94A20,20,0,0,0,167.31,236H208a20,20,0,0,0,19.85-22.48ZM190,104.23A28.05,28.05,0,0,1,176.29,84h11.18ZM182.47,44l2,16H71.53l2-16ZM68.53,84H79.71A28,28,0,0,1,66,104.22ZM85.6,212H52.53l10.14-81.11A52.1,52.1,0,0,0,103.83,84H116V94.47Zm84.81,0L140,94.47V84h12.17a52.09,52.09,0,0,0,41.16,46.88L203.47,212Z" }, null, -1), V = [
  ...
  setup(c) {
    const a = c, d = n("weight", "regular"), A = n("size", "1em"), H = n("color", "currentColor"), _ = n("mirrored", !1), l = i(() => a.weight ?? d), r = i(() => a.size ?? A), Z = i(() => a.color ?? H), M = i(() => a.mirrored !== void 0 ? a.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (h, F) => (o(), e("svg", m({
      ...
      g(h.$slots, "default"),
      t(l) === "bold" ? (o(), e("g", y, V)) : t(l) === "duotone" ? (o(), e("g", w, x)) : t(l) === "fill" ? (o(), e("g", S, C)) : t(l) === "light" ? (o(), e("g", B, P)) : t(l) === "regular" ? (o(), e("g", b, W)) : t(l) === "thin" ? (o(), e("g", $, q)) : L("", !0)
    ], 16, u));
  }
});
export {
