import { defineComponent as u, inject as l, computed as n, openBlock as o, createElementBlock as e, mergeProps as Z, unref as t, renderSlot as M, createCommentVNode as y, createElementVNode as c } from "vue";
const L = ["width", "height", "fill", "transform"], f = { key: 0 }, V = /* @__PURE__ */ c("path", { d: "M251.62,39.65a12,12,0,0,0-11.27-11.27c-53.28-3.14-96.2,13.37-114.84,44.14-12.14,20-12.56,44.17-1.46,67.3a75.21,75.21,0,0,0-11.24,20l-9.7-9.7c7.19-16.77,6.43-34.11-2.4-48.69C86.73,78.36,54.89,66,15.55,68.28A12,12,0,0,0,4.28,79.55C2,118.89,14.36,150.73,37.45,164.71a49.76,49.76,0,0,0,26,7.27,57.54,57.54,0,0,0,22.7-4.87L108,189v27a12,12,0,0,0,24,0V186.51a51.63,51.63,0,0,1,9.49-29.95A76.81,76.81,0,0,0,173.58,164a64.92,64.92,0,0,0,33.9-9.46C238.25,135.85,254.76,92.92,251.62,39.65ZM49.88,144.18c-13.19-8-21.18-27.46-21.83-52.13,24.67.65,44.14,8.65,52.13,21.83a26,26,0,0,1,3.63,17L72.48,119.51a12,12,0,0,0-17,17l11.34,11.34A26.27,26.27,0,0,1,49.88,144.18ZM195.05,134c-10.66,6.45-23,7.67-35.81,3.76l37.25-37.24a12,12,0,0,0-17-17l-37.25,37.24C138.37,108,139.59,95.61,146,85c12.77-21.09,43-33.07,82-33C228.14,91,216.14,121.18,195.05,134Z" }, null, -1), A = [
  V
], w = { key: 1 }, k = /* @__PURE__ */ c("path", {
  ...
  setup(d) {
    const s = d, _ = l("weight", "regular"), h = l("size", "1em"), C = l("color", "currentColor"), p = l("mirrored", !1), a = n(() => s.weight ?? _), i = n(() => s.size ?? h), g = n(() => s.color ?? C), m = n(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : p ? "scale(-1, 1)" : void 0);
    return (r, G) => (o(), e("svg", Z({
      ...
      M(r.$slots, "default"),
      t(a) === "bold" ? (o(), e("g", f, A)) : t(a) === "duotone" ? (o(), e("g", w, x)) : t(a) === "fill" ? (o(), e("g", S, B)) : t(a) === "light" ? (o(), e("g", N, b)) : t(a) === "regular" ? (o(), e("g", E, $)) : t(a) === "thin" ? (o(), e("g", j, D)) : y("", !0)
    ], 16, L));
  }
});
export {
