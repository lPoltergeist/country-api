import { defineComponent as g, inject as l, computed as i, openBlock as o, createElementBlock as e, mergeProps as m, unref as t, renderSlot as u, createCommentVNode as L, createElementVNode as a } from "vue";
const y = ["width", "height", "fill", "transform"], V = { key: 0 }, f = /* @__PURE__ */ a("path", { d: "M240.69,50.47a70.87,70.87,0,0,0-103.54,0A76.58,76.58,0,0,0,128,62.19a76.58,76.58,0,0,0-9.15-11.72,70.87,70.87,0,0,0-103.54,0,12,12,0,0,0,3.9,19.28L66,90.12a75.45,75.45,0,0,0-43.43,89,12,12,0,0,0,18.85,6.41L116,128.75V224a12,12,0,0,0,24,0V128.75l74.54,56.79a12,12,0,0,0,18.85-6.41,75.45,75.45,0,0,0-43.43-89l46.83-20.37a12,12,0,0,0,3.9-19.28ZM67.08,52a47.16,47.16,0,0,1,34.38,15A52.41,52.41,0,0,1,112.3,84.08L48,56.1A46.28,46.28,0,0,1,67.08,52ZM44.39,153.15a51.72,51.72,0,0,1,38.14-43.38A52.83,52.83,0,0,1,96.09,108a50.4,50.4,0,0,1,7,.47ZM205,133.81a51.14,51.14,0,0,1,6.57,19.34L153,108.46a52.21,52.21,0,0,1,20.51,1.31A51.61,51.61,0,0,1,205,133.81ZM143.7,84.08A52.41,52.41,0,0,1,154.54,67a47.16,47.16,0,0,1,34.38-15A46.28,46.28,0,0,1,208,56.1Z" }, null, -1), w = [
  f
  ...
  setup(d) {
    const n = d, _ = l("weight", "regular"), h = l("size", "1em"), A = l("color", "currentColor"), M = l("mirrored", !1), s = i(() => n.weight ?? _), r = i(() => n.size ?? h), Z = i(() => n.color ?? A), p = i(() => n.mirrored !== void 0 ? n.mirrored ? "scale(-1, 1)" : void 0 : M ? "scale(-1, 1)" : void 0);
    return (c, F) => (o(), e("svg", m({
      ...
      u(c.$slots, "default"),
      t(s) === "bold" ? (o(), e("g", V, w)) : t(s) === "duotone" ? (o(), e("g", k, S)) : t(s) === "fill" ? (o(), e("g", z, B)) : t(s) === "light" ? (o(), e("g", N, b)) : t(s) === "regular" ? (o(), e("g", E, $)) : t(s) === "thin" ? (o(), e("g", j, q)) : L("", !0)
    ], 16, y));
  }
});
export {
