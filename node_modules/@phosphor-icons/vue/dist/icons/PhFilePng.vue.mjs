import { defineComponent as m, inject as n, computed as c, openBlock as t, createElementBlock as o, mergeProps as H, unref as a, renderSlot as p, createCommentVNode as M, createElementVNode as e } from "vue";
const g = ["width", "height", "fill", "transform"], u = { key: 0 }, y = /* @__PURE__ */ e("path", { d: "M56,140H40a12,12,0,0,0-12,12v56a12,12,0,0,0,24,0v-4h4a32,32,0,0,0,0-64Zm0,40H52V164h4a8,8,0,0,1,0,16Zm176,20.87a12,12,0,0,1-3.33,8.3A34,34,0,0,1,204,220c-19.85,0-36-17.95-36-40s16.15-40,36-40a33.39,33.39,0,0,1,18.71,5.8,12,12,0,1,1-13.42,19.89A9.39,9.39,0,0,0,204,164c-6.5,0-12,7.33-12,16s5.5,16,12,16a9,9,0,0,0,2.7-.42A12,12,0,0,1,216,176h4a12,12,0,0,1,12,12ZM160,152v56a12,12,0,0,1-8.34,11.43A12.15,12.15,0,0,1,148,220a12,12,0,0,1-9.76-5L120,189.44V208a12,12,0,0,1-24,0V152a12,12,0,0,1,21.76-7L136,170.55V152a12,12,0,0,1,24,0ZM48,120a12,12,0,0,0,12-12V44h76V92a12,12,0,0,0,12,12h48v4a12,12,0,0,0,24,0V88a12,12,0,0,0-3.51-8.49l-56-56A12,12,0,0,0,152,20H56A20,20,0,0,0,36,40v68A12,12,0,0,0,48,120ZM160,57l23,23H160Z" }, null, -1), f = [
  ...
  setup(l) {
    const h = l, d = n("weight", "regular"), V = n("size", "1em"), _ = n("color", "currentColor"), Z = n("mirrored", !1), s = c(() => h.weight ?? d), i = c(() => h.size ?? V), A = c(() => h.color ?? _), v = c(() => h.mirrored !== void 0 ? h.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (r, D) => (t(), o("svg", H({
      ...
      p(r.$slots, "default"),
      a(s) === "bold" ? (t(), o("g", u, f)) : a(s) === "duotone" ? (t(), o("g", L, x)) : a(s) === "fill" ? (t(), o("g", S, C)) : a(s) === "light" ? (t(), o("g", B, P)) : a(s) === "regular" ? (t(), o("g", b, W)) : a(s) === "thin" ? (t(), o("g", $, F)) : M("", !0)
    ], 16, g));
  }
});
export {
