import { defineComponent as p, inject as n, computed as i, openBlock as a, createElementBlock as t, mergeProps as g, unref as l, renderSlot as u, createCommentVNode as M, createElementVNode as o } from "vue";
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, w = /* @__PURE__ */ o("path", { d: "M243.18,68.87A17.16,17.16,0,0,0,228.24,57l-34.83-3L179.83,22.41a17.24,17.24,0,0,0-31.66,0L134.6,54.07,99.76,57A17.13,17.13,0,0,0,90,87.11l26.3,22.46-7.87,33.36A17.2,17.2,0,0,0,134,161.56l30-17.82,30,17.82a17.19,17.19,0,0,0,25.58-18.63l-7.87-33.36L238,87.11A17.07,17.07,0,0,0,243.18,68.87ZM192.91,94A17.05,17.05,0,0,0,187.36,111l5.14,21.79-19.68-11.69a17.22,17.22,0,0,0-17.64,0L135.5,132.76,140.64,111A17,17,0,0,0,135.09,94l-17-14.49,22.54-1.9A17.17,17.17,0,0,0,155,67.3l9-20.91,9,20.9a17.18,17.18,0,0,0,14.38,10.36l22.54,1.9ZM32.49,184.49a12,12,0,0,1-17-17l52-52a12,12,0,1,1,17,17Zm68,4-52,52a12,12,0,0,1-17-17l52-52a12,12,0,0,1,17,17Zm72-17a12,12,0,0,1,0,17l-52,52a12,12,0,0,1-17-17l52-52A12,12,0,0,1,172.49,171.51Z" }, null, -1), k = [
  w
], S = { key: 1 }, v = /* @__PURE__ */ o("path", {
  ...
  setup(c) {
    const s = c, _ = n("weight", "regular"), h = n("size", "1em"), m = n("color", "currentColor"), L = n("mirrored", !1), e = i(() => s.weight ?? _), r = i(() => s.size ?? h), Z = i(() => s.color ?? m), A = i(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : L ? "scale(-1, 1)" : void 0);
    return (d, G) => (a(), t("svg", g({
      ...
      u(d.$slots, "default"),
      l(e) === "bold" ? (a(), t("g", f, k)) : l(e) === "duotone" ? (a(), t("g", S, z)) : l(e) === "fill" ? (a(), t("g", C, N)) : l(e) === "light" ? (a(), t("g", b, P)) : l(e) === "regular" ? (a(), t("g", V, $)) : l(e) === "thin" ? (a(), t("g", j, D)) : M("", !0)
    ], 16, y));
  }
});
export {
