import { defineComponent as V, inject as n, computed as i, openBlock as o, createElementBlock as e, mergeProps as M, unref as t, renderSlot as g, createCommentVNode as u, createElementVNode as a } from "vue";
const v = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ a("path", { d: "M208,52a91.68,91.68,0,0,0-29.9,5c-15.39-28.76-43.4-43.06-44.73-43.72a12,12,0,0,0-10.74,0c-1.33.66-29.34,15-44.74,43.72A91.57,91.57,0,0,0,48,52,12,12,0,0,0,36,64v80a92,92,0,0,0,184,0V64A12,12,0,0,0,208,52ZM60,77.06a68.15,68.15,0,0,1,55.72,60.73,91.89,91.89,0,0,0-55.72-29Zm56,133.88A68.12,68.12,0,0,1,60,144V133.06A68.12,68.12,0,0,1,116,200ZM99.37,67.71c8.2-14.94,21.32-25,28.63-29.77,7.32,4.79,20.43,14.83,28.63,29.77A92.69,92.69,0,0,0,128,98.61,92.8,92.8,0,0,0,99.37,67.71ZM196,144a68.12,68.12,0,0,1-56,66.94V200a68.12,68.12,0,0,1,56-66.94Zm0-35.22a91.89,91.89,0,0,0-55.72,29A68.15,68.15,0,0,1,196,77.06Z" }, null, -1), w = [
  f
], C = { key: 1 }, k = /* @__PURE__ */ a("path", {
  ...
  setup(l) {
    const c = l, _ = n("weight", "regular"), h = n("size", "1em"), A = n("color", "currentColor"), Z = n("mirrored", !1), s = i(() => c.weight ?? _), r = i(() => c.size ?? h), m = i(() => c.color ?? A), p = i(() => c.mirrored !== void 0 ? c.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (d, H) => (o(), e("svg", M({
      ...
      g(d.$slots, "default"),
      t(s) === "bold" ? (o(), e("g", y, w)) : t(s) === "duotone" ? (o(), e("g", C, x)) : t(s) === "fill" ? (o(), e("g", z, N)) : t(s) === "light" ? (o(), e("g", b, P)) : t(s) === "regular" ? (o(), e("g", W, j)) : t(s) === "thin" ? (o(), e("g", G, D)) : u("", !0)
    ], 16, v));
  }
});
export {
