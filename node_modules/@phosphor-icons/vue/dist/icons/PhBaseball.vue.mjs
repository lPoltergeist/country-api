import { defineComponent as g, inject as n, computed as i, openBlock as a, createElementBlock as o, mergeProps as u, unref as t, renderSlot as y, createCommentVNode as M, createElementVNode as e } from "vue";
const f = ["width", "height", "fill", "transform"], w = { key: 0 }, k = /* @__PURE__ */ e("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20ZM77,194.66A108.9,108.9,0,0,0,85.54,182a12,12,0,1,0-20.77-12A83.28,83.28,0,0,1,60,177.27a83.73,83.73,0,0,1,0-98.54A83.28,83.28,0,0,1,64.77,86,12,12,0,1,0,85.54,74,108.9,108.9,0,0,0,77,61.34a83.76,83.76,0,0,1,102.06,0A108.9,108.9,0,0,0,170.46,74a12,12,0,1,0,20.77,12A83.28,83.28,0,0,1,196,78.73a83.73,83.73,0,0,1,0,98.54,83.28,83.28,0,0,1-4.74-7.28,12,12,0,1,0-20.77,12A108.9,108.9,0,0,0,179,194.66a83.76,83.76,0,0,1-102.06,0Zm22.2-80.14A110,110,0,0,1,100,128a110,110,0,0,1-.83,13.48A12,12,0,0,1,87.27,152a12.83,12.83,0,0,1-1.5-.09,12,12,0,0,1-10.42-13.39A85.75,85.75,0,0,0,76,128a85.75,85.75,0,0,0-.65-10.52,12,12,0,1,1,23.82-3Zm71.06,37.39a12.83,12.83,0,0,1-1.5.09,12,12,0,0,1-11.9-10.52,109.88,109.88,0,0,1,0-27,12,12,0,1,1,23.82,3,85.46,85.46,0,0,0,0,21A12,12,0,0,1,170.23,151.91Z" }, null, -1), v = [
  k
], x = { key: 1 }, S = /* @__PURE__ */ e("path", {
  ...
  setup(d) {
    const s = d, A = n("weight", "regular"), _ = n("size", "1em"), h = n("color", "currentColor"), m = n("mirrored", !1), c = i(() => s.weight ?? A), r = i(() => s.size ?? _), Z = i(() => s.color ?? h), p = i(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
    return (l, G) => (a(), o("svg", u({
      ...
      y(l.$slots, "default"),
      t(c) === "bold" ? (a(), o("g", w, v)) : t(c) === "duotone" ? (a(), o("g", x, B)) : t(c) === "fill" ? (a(), o("g", C, b)) : t(c) === "light" ? (a(), o("g", N, P)) : t(c) === "regular" ? (a(), o("g", V, $)) : t(c) === "thin" ? (a(), o("g", j, D)) : M("", !0)
    ], 16, f));
  }
});
export {
