...
const f = ["width", "height", "fill", "transform"], M = { key: 0 }, w = /* @__PURE__ */ e("path", { d: "M28,72a12,12,0,0,1,3.51-8.49A61.26,61.26,0,0,1,46.63,53.27,92.82,92.82,0,0,1,88,44c19.63,0,34,9.57,46.66,18,11.25,7.5,21,14,33.34,14,26.1,0,39.08-12.07,39.62-12.58A11.61,11.61,0,0,1,216,60a12,12,0,0,1,8.49,20.49,61.26,61.26,0,0,1-15.12,10.24A92.82,92.82,0,0,1,168,100c-19.63,0-34-9.57-46.66-18-11.25-7.5-21-14-33.34-14C61.9,68,49,80,48.49,80.49A12,12,0,0,1,28,72ZM216,172a11.61,11.61,0,0,0-8.38,3.42C207.08,175.93,194.1,188,168,188c-12.37,0-22.09-6.48-33.34-14-12.67-8.45-27-18-46.66-18a92.82,92.82,0,0,0-41.37,9.27,61.26,61.26,0,0,0-15.12,10.24,12,12,0,0,0,17,17C49,192,61.9,180,88,180c12.37,0,22.09,6.48,33.34,14,12.67,8.45,27,18,46.66,18a92.82,92.82,0,0,0,41.37-9.27,61.26,61.26,0,0,0,15.12-10.24A12,12,0,0,0,216,172Zm0-56a11.61,11.61,0,0,0-8.38,3.42C207.08,119.93,194.1,132,168,132c-12.37,0-22.09-6.48-33.34-14-12.67-8.45-27-18-46.66-18a92.82,92.82,0,0,0-41.37,9.27,61.26,61.26,0,0,0-15.12,10.24,12,12,0,0,0,17,17C49,136,61.9,124,88,124c12.37,0,22.09,6.48,33.34,14,12.67,8.45,27,18,46.66,18a92.82,92.82,0,0,0,41.37-9.27,61.26,61.26,0,0,0,15.12-10.24A12,12,0,0,0,216,116Z" }, null, -1), k = [
  ...
  setup(l) {
    const s = l, C = n("weight", "regular"), _ = n("size", "1em"), h = n("color", "currentColor"), m = n("mirrored", !1), a = i(() => s.weight ?? C), r = i(() => s.size ?? _), p = i(() => s.color ?? h), A = i(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
    return (d, G) => (o(), c("svg", u({
      ...
      Z(d.$slots, "default"),
      t(a) === "bold" ? (o(), c("g", M, k)) : t(a) === "duotone" ? (o(), c("g", S, V)) : t(a) === "fill" ? (o(), c("g", z, N)) : t(a) === "light" ? (o(), c("g", W, E)) : t(a) === "regular" ? (o(), c("g", H, $)) : t(a) === "thin" ? (o(), c("g", j, D)) : y("", !0)
    ], 16, f));
  }
});
export {
