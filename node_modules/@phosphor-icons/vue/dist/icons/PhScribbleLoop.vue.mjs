...
const A = ["width", "height", "fill", "transform"], M = { key: 0 }, w = /* @__PURE__ */ c("path", { d: "M248.9,152c-1.33-1.47-23.75-25.85-60.21-40.69-2.15-18.28-9.1-34.9-20.1-47.71C153.12,45.52,130.79,36,104,36,50.44,36,15.69,83.79,14.24,85.82a12,12,0,0,0,19.53,14C34.05,99.38,62.65,60,104,60c19.85,0,35.45,6.45,46.38,19.18a61.35,61.35,0,0,1,12.4,24A143.6,143.6,0,0,0,132.61,100c-27,0-49.79,7.13-65.85,20.63C52.3,132.79,44,149.78,44,167.25,44,193.46,63.44,220,100.61,220c51.93,0,82.34-40.28,87.87-82.43a156.46,156.46,0,0,1,42.62,30.48A12,12,0,1,0,248.9,152ZM148.37,173.74C140.09,183.9,125.09,196,100.61,196,78.08,196,68,181.56,68,167.25,68,146.42,88.22,124,132.61,124a119.85,119.85,0,0,1,32.64,4.62C164.24,145.44,158.21,161.66,148.37,173.74Z" }, null, -1), k = [
  ...
  setup(l) {
    const n = l, _ = i("weight", "regular"), h = i("size", "1em"), C = i("color", "currentColor"), p = i("mirrored", !1), s = a(() => n.weight ?? _), r = a(() => n.size ?? h), m = a(() => n.color ?? C), g = a(() => n.mirrored !== void 0 ? n.mirrored ? "scale(-1, 1)" : void 0 : p ? "scale(-1, 1)" : void 0);
    return (d, F) => (o(), e("svg", y({
      ...
      Z(d.$slots, "default"),
      t(s) === "bold" ? (o(), e("g", M, k)) : t(s) === "duotone" ? (o(), e("g", v, z)) : t(s) === "fill" ? (o(), e("g", b, V)) : t(s) === "light" ? (o(), e("g", N, H)) : t(s) === "regular" ? (o(), e("g", P, $)) : t(s) === "thin" ? (o(), e("g", j, q)) : f("", !0)
    ], 16, A));
  }
});
export {
