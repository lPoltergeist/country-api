import { defineComponent as p, inject as c, computed as n, openBlock as o, createElementBlock as e, mergeProps as g, unref as t, renderSlot as u, createCommentVNode as L, createElementVNode as a } from "vue";
const y = ["width", "height", "fill", "transform"], f = { key: 0 }, w = /* @__PURE__ */ a("path", { d: "M178,78A84,84,0,1,0,78,178,84,84,0,1,0,178,78Zm42,82a60.75,60.75,0,0,1-.38,6.65l-44-44a83.31,83.31,0,0,0,4-19.34A60.09,60.09,0,0,1,220,160Zm-74-30.94L126.94,110a59.57,59.57,0,0,1,28.9-9.81A59.57,59.57,0,0,1,146,129.06ZM110,126.94,129.06,146a59.57,59.57,0,0,1-28.9,9.81A59.57,59.57,0,0,1,110,126.94Zm42.7-50.6a83.31,83.31,0,0,0-19.34,4l-44-44A60.75,60.75,0,0,1,96,36,60.09,60.09,0,0,1,152.67,76.34ZM64.19,45.16l46.73,46.73a85,85,0,0,0-19,19L45.16,64.19A60.45,60.45,0,0,1,64.19,45.16ZM36,96a60.75,60.75,0,0,1,.38-6.65l44,44a83.31,83.31,0,0,0-4,19.34A60.09,60.09,0,0,1,36,96Zm67.33,83.66a83.31,83.31,0,0,0,19.34-4l44,44A60.75,60.75,0,0,1,160,220,60.09,60.09,0,0,1,103.33,179.66Zm88.48,31.18-46.73-46.73a85,85,0,0,0,19-19l46.73,46.73A60.45,60.45,0,0,1,191.81,210.84Z" }, null, -1), C = [
  w
  ...
  setup(A) {
    const s = A, Z = c("weight", "regular"), d = c("size", "1em"), _ = c("color", "currentColor"), h = c("mirrored", !1), l = n(() => s.weight ?? Z), i = n(() => s.size ?? d), m = n(() => s.color ?? _), M = n(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : h ? "scale(-1, 1)" : void 0);
    return (r, D) => (o(), e("svg", g({
      ...
      u(r.$slots, "default"),
      t(l) === "bold" ? (o(), e("g", f, C)) : t(l) === "duotone" ? (o(), e("g", k, S)) : t(l) === "fill" ? (o(), e("g", z, N)) : t(l) === "light" ? (o(), e("g", b, H)) : t(l) === "regular" ? (o(), e("g", P, W)) : t(l) === "thin" ? (o(), e("g", $, U)) : L("", !0)
    ], 16, y));
  }
});
export {
