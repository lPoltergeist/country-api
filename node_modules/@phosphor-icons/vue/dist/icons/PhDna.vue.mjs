import { defineComponent as g, inject as h, computed as i, openBlock as t, createElementBlock as o, mergeProps as m, unref as a, renderSlot as u, createCommentVNode as M, createElementVNode as e } from "vue";
const Z = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ e("path", { d: "M204,204.5V232a12,12,0,0,1-24,0V204.5a59.68,59.68,0,0,0-33.17-53.67l-48.4-24.2A83.54,83.54,0,0,1,52,51.5V24a12,12,0,0,1,24,0V51.5a59.68,59.68,0,0,0,33.17,53.67l48.4,24.2A83.54,83.54,0,0,1,204,204.5Zm-52-.5H76a59.75,59.75,0,0,1,2.34-16h56.2a12,12,0,0,0,0-24H91.76c1-1.1,2-2.18,3.13-3.21a12,12,0,0,0-16.45-17.48A84.38,84.38,0,0,0,52,204.5V232a12,12,0,0,0,24,0v-4h76a12,12,0,0,0,0-24ZM192,12a12,12,0,0,0-12,12v4H104a12,12,0,0,0,0,24h76a59.75,59.75,0,0,1-2.34,16H121.44a12,12,0,0,0,0,24h42.8c-1,1.1-2,2.18-3.13,3.21a12,12,0,0,0,16.45,17.48A84.38,84.38,0,0,0,204,51.5V24A12,12,0,0,0,192,12Z" }, null, -1), v = [
  f
  ...
  setup(c) {
    const n = c, d = h("weight", "regular"), V = h("size", "1em"), _ = h("color", "currentColor"), A = h("mirrored", !1), s = i(() => n.weight ?? d), l = i(() => n.size ?? V), p = i(() => n.color ?? _), H = i(() => n.mirrored !== void 0 ? n.mirrored ? "scale(-1, 1)" : void 0 : A ? "scale(-1, 1)" : void 0);
    return (r, F) => (t(), o("svg", m({
      ...
      u(r.$slots, "default"),
      a(s) === "bold" ? (t(), o("g", y, v)) : a(s) === "duotone" ? (t(), o("g", w, S)) : a(s) === "fill" ? (t(), o("g", z, B)) : a(s) === "light" ? (t(), o("g", L, b)) : a(s) === "regular" ? (t(), o("g", E, W)) : a(s) === "thin" ? (t(), o("g", $, D)) : M("", !0)
    ], 16, Z));
  }
});
export {
